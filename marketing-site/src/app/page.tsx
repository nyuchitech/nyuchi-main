/**
 * Nyuchi Marketing Site - Landing Page
 * www.nyuchi.com
 * "I am because we are"
 */
...
const communityFeatures = [
  {
    ...
    href: `${PLATFORM_URL}/community/directory`,
    free: true,
  },
  {
    ...
    href: `${PLATFORM_URL}/community/travel-directory`,
    free: true,
  },
  {
    ...
    href: `${PLATFORM_URL}/community/leaderboard`,
    free: true,
  },
  {
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
              Nyuchi (meaning &quot;bee&quot; in Shona) represents the industrious spirit of African entrepreneurship.
              Like bees working together for the hive, we believe in the power of community and collective growth.
            </Typography>
            <Typography variant="body1" color="text.secondary">
              Our platform is built on Ubuntu philosophy - the belief that &quot;I am because we are.&quot;
              We provide tools for entrepreneurs to connect, collaborate, and grow their businesses
              while staying true to African values of community and mutual support.
            </Typography>
          </Box>
        </Container>
      </Box>
