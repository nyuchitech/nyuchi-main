  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-button text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // v6 mineral variants
        cobalt: "bg-mineral-cobalt text-white hover:bg-mineral-cobalt/90",
        tanzanite: "bg-mineral-tanzanite text-white hover:bg-mineral-tanzanite/90",
        malachite: "bg-mineral-malachite text-white hover:bg-mineral-malachite/90",
        gold: "bg-mineral-gold text-white hover:bg-mineral-gold/90",
        terracotta: "bg-mineral-terracotta text-white hover:bg-mineral-terracotta/90",
      },
      size: {
